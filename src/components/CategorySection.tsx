...
const categories: Category[] = [
  ...
  { name: "Strength & Physique", icon: Dumbbell, count: 1560, color: "from-red-500 to-orange-500" },
  { name: "Power Dynamics", icon: Crown, count: 780, color: "from-amber-500 to-yellow-500" },
  { name: "Combat Sports", icon: Swords, count: 2340, color: "from-rose-500 to-red-500" },
  { name: "Physique Flex Shows", icon: Flame, count: 920, color: "from-orange-500 to-amber-500" },
  { name: "Impact Training", icon: Zap, count: 650, color: "from-yellow-500 to-lime-500" },
